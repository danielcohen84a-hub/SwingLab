...
def objective(trial, processed_df, config):
    ...
    model = SwingLabLSTM(sequence_length, X_train.shape[2], trial_config)
    ...
    try:
        history = model.train(
            ...
            epochs=15, # 15 epochs is enough to see the trend
            batch_size=256,
...
def run_tuning(n_trials=20):
    print("\n" + "="*60)
    print("  SWINGLAB AUTO-TUNER: The 30-Minute Pro Strategy")
    print("="*60)
